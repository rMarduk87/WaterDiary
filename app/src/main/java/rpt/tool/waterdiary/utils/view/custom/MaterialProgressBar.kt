...
class MaterialProgressBar : View {
    ...
    private fun parseAttributes(a: TypedArray) {
        ...
        circleRadius = a.getDimension(
            R.styleable.MaterialProgressBar_matProg_circleRadius,
        ...
        barWidth =
            a.getDimension(R.styleable.MaterialProgressBar_matProg_barWidth, barWidth.toFloat())
                .toInt()

        rimWidth =
            a.getDimension(R.styleable.MaterialProgressBar_matProg_rimWidth, rimWidth.toFloat())
                .toInt()

        val baseSpinSpeed: Float =
            a.getFloat(R.styleable.MaterialProgressBar_matProg_spinSpeed, spinSpeed / 360.0f)
        spinSpeed = baseSpinSpeed * 360

        barSpinCycleTime =
            a.getInt(
                R.styleable.MaterialProgressBar_matProg_barSpinCycleTime,
    ...
    public override fun onRestoreInstanceState(state: Parcelable) {
        ...
        val ss = state as WheelSavedState
    ...
    companion object {
        private val TAG: String = MaterialProgressBar::class.java.simpleName
    }
}
