...
abstract class RoundedCornersTransformation @JvmOverloads constructor(
    ...
    fun transform(resource: Resource<Bitmap?>, outWidth: Int, outHeight: Int): Resource<Bitmap> {
        val source = resource.get()

        val width = source.width
        val height = source.height

        val bitmap = mBitmapPool[width, height, Bitmap.Config.ARGB_8888]
